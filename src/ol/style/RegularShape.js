...
class RegularShape extends ImageStyle {
  ...
  getHitDetectionImage(pixelRatio) {
    if (!this.hitDetectionCanvas_[pixelRatio]) {
      const renderOptions = this.createRenderOptions();

      this.createHitDetectionCanvas_(renderOptions, pixelRatio);
    }
    return this.hitDetectionCanvas_[pixelRatio];
  }
  ...
  getImage(pixelRatio) {
    if (!this.canvas_[pixelRatio]) {
      ...
      this.canvas_[pixelRatio] = context.canvas;
    }
